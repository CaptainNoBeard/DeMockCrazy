...
def get_votes_GOP():
    ...
    leadGOP = name + ' is in the lead of the GOP primary race, with '+ pts + ' percent of the ' + party + ' vote.'
    return leadGOP
...
def get_votes_DEM():
    ...
    leadDEM = name + ' is in the lead of the Democratic primary race, with '+ pts + ' percent of the ' + party + ' vote.'
    return leadDEM
